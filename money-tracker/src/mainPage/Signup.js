...
const SignUp = () => {
    return (
        <>
        <Container>
        <h1 style={{ fontSize: "1.2rem", marginTop: '3rem'}}>Create a MONEZ 💰 account</h1>

            <Link href="/login">or sign in to your account</Link>
            <Exp for="EMZIL"><b>Email <Span>(or Username)</Span></b></Exp>
    <Input type="text" placeholder="eg., dana.cohen@fbi.gov" name="uname" required></Input>
